  ...
  const setupSteps = [
    ...
    },
    {
      ...
      steps: [
        ...
        "Click 'Add Lesson' or 'Add Lessons' for bulk creation (some teachers prefer to add lessons as they go, others add lessons and lesson points at the start of the term; both are supported)",
        "Set lesson name, type, and point value",
        "Set lesson dates accurately so reports include grades in the correct grading period",
        "If needed, add, remove, or edit lessons directly from Grade Entry while grading"
      ],
      status: "recommended"
    },
    {
